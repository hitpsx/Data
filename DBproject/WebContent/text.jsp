						...
						<div class="grid-1">
							...
							<div class="grid-graph">
								<div class="grid-graph1">
									<div id="os-Win-lbl">
										Micro-Computer <span><s:property value="gh.computer" /></span>
									</div>
									<div id="os-Mac-lbl">
										ORouter <span><s:property value="gh.office" /></span>
									</div>
									<div id="os-Other-lbl">
										Switch <span><s:property value="gh.router" /></span>
									</div>
									<div id="os-server-lbl">
										Server <span><s:property value="gh.server" /></span>
									</div>
									<div id="os-lbl" class="os-lbl">
										Office-Equipment <span><s:property value="gh.swtch" /></span>
									</div>
								</div>
							</div>
							<div class="grid-2">
